import { ProjectItemProps } from "@/data/types/project.entity";
    ...
    <CommonCard className="">
      ...
      <div className="p-4">
        ...
        <div className="flex justify-end gap-2 mt-4">
          ...
          {!!item.links.demo && (
            <button className="text-sm px-3 py-1 border border-stone-300 bg-stone-100 text-black rounded-md hover:bg-stone-200">
