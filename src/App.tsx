...
const portfolioProjects = [
  {
    title: "텐스토리",
    description: "온라인 영어 동화 학습 솔루션으로, 아이들이 재미있게 영어를 배울 수 있도록 설계된 교육 플랫폼입니다. 인터랙티브한 스토리텔링과 학습 진도 관리 기능을 제공합니다.",
    ...
    image: "https://images.unsplash.com/photo-1649451844931-57e22fc82de3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx3ZWIlMjBkZXZlbG9wbWVudCUyMGRhc2hib2FyZCUyMGludGVyZmFjZXxlbnwxfHx8fDE3NTg4NTIzODZ8MA&ixlib=rb-4.1.0&q=80&w=1080",
    ...
    challenge: "아이들의 집중력 유지와 학습 효과 측정이 가장 큰 도전이었습니다. 기존 온라인 학습의 한계를 극복하고 개인별 맞춤 학습을 제공해야 했습니다.",
    solution: "게임화 요소와 AI 기반 개인화 학습 시스템을 도입했습니다. 실시간 음성 인식 기술로 발음을 평가하고, 학습 패턴 분석을 통해 맞춤형 콘텐츠를 제공했습니다.",
    outcome: "출시 6개월 만에 10,000명의 활성 사용자를 확보했으며, 85%의 높은 학습 완료율을 달성했습니다. 교육부 우수 콘텐츠로 선정되어 공신력을 인정받았습니다."
  },
  {
    title: "모바일 쇼핑 앱",
    description: "사용자 친화적인 모바일 쇼핑 경험을 제공하는 e-커머스 애플리케이션입니다. 직관적인 UI/UX와 빠른 결제 시스템으로 최적화된 쇼핑 환경을 구현했습니다.",
    developmentEnvironment: "Mobile",
    developmentLanguage: "React Native",
    field: "Mobile App Development",
    deviceType: "mobile" as const,
    url: "https://shopping-app.com",
    image: "https://images.unsplash.com/photo-1618761714954-0b8cd0026356?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb2JpbGUlMjBhcHAlMjBkZXNpZ24lMjBpbnRlcmZhY2V8ZW58MXx8fHwxNzU4ODE1Mzk0fDA&ixlib=rb-4.1.0&q=80&w=1080",
    ...
    challenge: "모바일 환경에서 복잡한 쇼핑 과정을 단순화하고, 높은 구매 전환율을 달성하는 것이 주요 과제였습니다.",
    solution: "UX 리서치를 통해 사용자 여정을 최적화하고, 원터치 결제와 AI 추천 시스템을 구현했습니다. 성능 최적화로 로딩 시간을 50% 단축했습니다.",
    outcome: "출시 후 3개월 만에 50,000+ 다운로드를 기록했으며, 12%의 높은 전환율을 달성했습니다. 일 평균 거래액 500만원을 달성하며 성공적인 런칭을 이뤘습니다."
  },
  {
    title: "기업 관리 시스템",
    description: "중소기업을 위한 통합 관리 솔루션으로, 직원 관리, 프로젝트 추적, 재무 관리 등 비즈니스 운영에 필요한 모든 기능을 하나의 플랫폼에서 제공합니다.",
    developmentEnvironment: "Web",
    developmentLanguage: "Vue.js",
    field: "Full-Stack Development",
    deviceType: "pc" as const,
    url: "https://enterprise-system.com",
    image: "https://images.unsplash.com/photo-1694599048261-a1de00f0117e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHx8ZS1jb21tZXJjZSUyMHdlYnNpdGUlMjBkZXNpZ258ZW58MXx8fHwxNzU4NzUzNjk4fDA&ixlib=rb-4.1.0&q=80&w=1080",
    ...
    challenge: "각기 다른 중소기업의 다양한 요구사항을 하나의 시스템으로 통합하고, 복잡한 비즈니스 로직을 단순화하는 것이 가장 큰 도전이었습니다.",
    solution: "모듈화된 아키텍처를 설계하여 커스터마이징 가능한 시스템을 구축했습니다. 사용자 친화적인 인터페이스와 강력한 분석 도구를 제공했습니다.",
    outcome: "30개 기업에 성공적으로 도입되어 평균 40%의 업무 효율성 향상을 달성했습니다. 연간 5억원의 매출을 기록하며 B2B SaaS 시장에서 입지를 확립했습니다."
  }
];
...
export default function App() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const section = Math.min(Math.floor(scrolled / sectionHeight), portfolioProjects.length * 2 - 1);
      ...
      <div className="relative z-10">
          ...
          <div className="max-w-7xl mx-auto px-8 py-4">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-2 md:space-x-4">
                ...
                {/* 모바일용 아이콘만 */}
                <Button variant="ghost" size="sm" className="text-white hover:bg-white/10 sm:hidden w-8 h-8 p-0">
        ...
        <div className="hidden md:flex fixed bottom-8 right-8 z-50 flex-col space-y-2">
          ...
          <Button
            variant="ghost"
            size="sm"
            onClick={() => scrollToSection(Math.min(currentSection + 1, portfolioProjects.length * 2 - 1))}
        ...
        {/* 푸터 정보 */}
        <footer className="relative z-10 pb-32 md:pb-20">
          {/* <div className="max-w-7xl mx-auto px-4 md:px-8 text-center">
            <div className="bg-white/5 backdrop-blur-md rounded-lg p-6 md:p-8 border border-white/10">
              <h3 className="text-white text-lg md:text-xl mb-4">더 많은 프로젝트를 보고 싶으시다면</h3>
