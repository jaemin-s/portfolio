...
export const CAREER_DATA: CareerEntity[] = [
  {
    companyName: "(주)홈초이스",
    logoUrl:
      "https://github.com/jaemin-s/jaemin-s/raw/refs/heads/main/image/logo/homechoice.svg",
    employmentPeriod: "2024.01 ~ 재직중",
    companyDescription:
      "VOD, 배급, 광고, 채널 등의 다양한 사업을 영위하는 종합미디어 그룹",
    achievementItems: [
      {
